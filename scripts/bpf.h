...
// JB: since verifier changes ctx access
struct xdp_md {
  void *data;
  void *data_end;
  void *data_meta;
  ...
  __u32 frame_sz; /* frame size to deduce data_hard_end/reserved tailroom*/
  __u32 flags; /* supported values defined in xdp_buff_flags */
};
